    ...
    const fetchAll = async () => {
      try {
        ...
        const [summaryRes, activityRes, decisionsRes, categoriesRes] =
          await Promise.all([
            fetch(`${VITE_API_URL_BACK}/api/v1/stats/summary?period=week`),
            fetch(`${VITE_API_URL_BACK}/api/v1/stats/chart/activity?period=week`),
            fetch(`${VITE_API_URL_BACK}/api/v1/stats/chart/decisions?period=week`),
            fetch(
              `${VITE_API_URL_BACK}/api/v1/stats/chart/categories?period=week`,
            ),
          ]);
